...
import Navbar from "@/app/components/ui/website/Navbar";
import Footer from "@/app/components/ui/website/Footer";
    ...
    <main>
      ...
      <section className="bg-cream overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-2 gap-0 md:gap-12 items-stretch mt-24">
          {/* Left */}
          <div className="max-w-lg pt-4 md:pt-0 py-0  md:py-32 flex flex-col items-center md:items-start text-center md:text-left justify-center">
            <motion.span
            ...
            <MotionLink
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex bg-maroon text-cream font-sans font-medium px-7 py-3.5 rounded-full hover:bg-maroon/90 transition-colors text-sm w-fit"
            >
              Apply to join
            </MotionLink>
          </div>
          ...
          <motion.div
            ...
            className="flex items-center justify-center pt-0  md:pt-28 lg:pt-0"
          >
            <div className="relative w-full max-w-120 h-120 lg:h-140">
              <Image
                src="/TalentCard.png"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center flex-col">
          ...
          <div className="flex flex-col items-center md:flex-row md:items-center md:justify-center mb-16 relative gap-6 md:gap-0">
            {steps.map((step, index) => (
              <div
                key={step.number}
                className={`${step.rotate} bg-white border-2 border-dashed border-maroon/40 rounded-2xl p-8 transition-transform hover:rotate-0 duration-300 shrink-0 w-full max-w-sm md:w-96.75 md:h-76.5 md:max-w-none ${
                  index > 0 ? "md:-ml-10" : ""
                }`}
