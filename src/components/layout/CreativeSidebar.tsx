  ...
  return (
    <aside className="w-56 border-r border-gray-200 flex flex-col shrink-0 h-full" style={{ background: '#EFE9E2' }}>
      ...
      <div className="px-4 py-5">
        <span className="text-4xl text-sm  font-bold font-editorial font-sans tracking-widest text-gray-900 uppercase" style={{ fontFamily: 'var(--font-editorial)' }}>BRANDCOVE</span>
      </div>
